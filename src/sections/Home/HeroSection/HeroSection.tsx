...
const HeroSection: React.FC = () => {
  ...
  const leftContentHeading = useRef<HTMLDivElement>(null);
  const leftContentText = useRef<HTMLDivElement>(null);
  const leftContentSocials = useRef<HTMLDivElement>(null);
