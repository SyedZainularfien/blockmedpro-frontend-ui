    ...
    <div className="block lg:hidden !z-50">
      ...
      >
        {/* <img
          ...
          className="w-6 h-6"
        /> */}
        <svg className="text-vavid-gray size-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M0 96C0 78.3 14.3 64 32 64l384 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 128C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32l384 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 288c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32L32 448c-17.7 0-32-14.3-32-32s14.3-32 32-32l384 0c17.7 0 32 14.3 32 32z" /></svg>
      </button>
      <div
        className={`!z-50 bg-white text-river-blue w-screen h-full fixed top-0 left-0 flex py-4 ${navShow ? "translate-x-[0%]" : "-translate-x-[110%]"
          }`}
        ...
        <div className="flex flex-col items-center justify-between w-11/12 mx-auto">
          <div className="w-full space-y-4">
            <div className="flex items-center justify-between w-full">
              <Link to="/" className="text-river-blue">
                <img
                  className="w-[80%]"
              ...
              >
                {/* <img
                  ...
                  className="w-30 h-30"
                /> */}
                <svg className="text-river-blue size-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM175 175c9.4-9.4 24.6-9.4 33.9 0l47 47 47-47c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-47 47 47 47c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-47-47-47 47c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l47-47-47-47c-9.4-9.4-9.4-24.6 0-33.9z" /></svg>
              </button>
            </div>
