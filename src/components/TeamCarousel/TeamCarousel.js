...
const renderPrevButton = ({ isDisabled }) => {
  return (
    <button
      disabled={isDisabled}
      className={`flex absolute items-center justify-center bottom-[5%] left-[20%] sm:left-[30%] w-[30px] h-[30px] rounded-full ${isDisabled ? "bg-[#808080]" : "bg-river-blue"
        }`}
    >
      {/* <img
      ...
      /> */}
      <svg className="w-2 text-white rotate-180" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 320 512"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z" /></svg>
    </button>
  );
};
...
const renderNextButton = ({ isDisabled }) => {
  return (
    <button
      disabled={isDisabled}
      className={`flex absolute items-center justify-center bottom-[5%] right-[20%] sm:right-[30%] w-[30px] h-[30px] rounded-full ${isDisabled ? "bg-[#808080]" : "bg-river-blue"
        }`}
    >
      {/* <img
        src="/assets/Images/next-icon.png"
        ...
        height={8}
      /> */}
      <svg className="w-2 text-white" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 320 512"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z" /></svg>
    </button>
  );
};
...
const TeamCarouselCard = ({ index, item }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center mx-auto absolute w-[80%] top-[2%] left-0 right-0 z-[-1]" style={styles}>
        <img
          src={item.imgURL}
          loading="lazy"
          alt="BlockMed Plus Sign"
          className={`rounded-full w-[240px] h-[240px] xl:w-[255px] xl:h-[255px] object-cover ${loading ? "opacity-0" : "opacity-100"}`}
