        ...
        <div className="flex flex-col gap-3 py-10 lg:w-3/4">
          ...
          <div ref={text} className="flex flex-col gap-4">
            <StyledMdText
              ...
              <span>
                BlockMed Pro envisions a healthcare system where patients have full control over their </span>
              <span> medical data, empowering them to make informed decisions and even monetise their</span>
              <span> records if they choose. Our user-focused platform ensures a seamless, intuitive </span>
              <span> records through the robust, transparent, and secure infrastructure provided </span>
              <span> experience for both patients and healthcare providers, making electronic health record </span>
            ...
            <StyledMdText
              ...
              <span>
                ...
                With trust and integrity at our core, we utilise blockchain technology to provide the </span>
              <span> highest level of security and privacy, ensuring patient autonomy while maintaining strict </span>
              <span> compliance with regulatory standards. Our dedication to innovation drives us to </span>
              <span> continuously enhance healthcare delivery, bridging the gap between providers and </span>
              <span> patients through a secure, transparent, and efficient ecosystem. </span>
