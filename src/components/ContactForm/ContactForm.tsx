        ...
        <div>
          ...
          <div className="mt-1">
            <input
              ...
              className={`block w-full rounded-md px-3.5 py-2 shadow-sm sm:text-lg sm:leading-6 outline-none bg-transparent border ${
                firstNameError ? "border-red-500" : "border-vavid-gray"
              } text-river-blue`}
            />
            {firstNameError && (
        ...
        <div>
          ...
          <div className="mt-1">
            <input
              ...
              className={`block w-full rounded-md px-3.5 py-2 shadow-sm sm:text-lg sm:leading-6 outline-none bg-transparent border ${
                lastNameError ? "border-red-500" : "border-vavid-gray"
              } text-river-blue`}
            />
            {lastNameError && (
              <p className="text-sm text-red-500">Minimum characters: 3</p>
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-1">
            <input
              ...
              className={`block w-full rounded-md px-3.5 py-2 shadow-sm sm:text-lg sm:leading-6 outline-none bg-transparent border ${
                emailError ? "border-red-500" : "border-vavid-gray"
              } text-river-blue`}
            />
            {emailError && (
          ...
          <div className="mt-1">
            <div className="flex items-center gap-2">
              <select
                ...
                onChange={(e) =>
                  handleInputChange(e, setCountryCode, setCountryCodeError)
                }
                className={` h-[42px] w-[100px] block rounded-md px-3.5 py-2 shadow-sm sm:text-lg sm:leading-6 outline-none appearance-none border ${
                  phoneNumberError ? "border-red-500" : "border-vavid-gray"
                } text-river-blue`}
              >
        ...
        <div>
          ...
          <div className="mt-1">
            <input
              ...
              className={`block w-full rounded-md px-3.5 py-2 shadow-sm sm:text-lg sm:leading-6 outline-none bg-transparent border ${
                locationError ? "border-red-500" : "border-vavid-gray"
              } text-river-blue`}
            />
            {locationError && (
              <p className="text-sm text-red-500">Minimum characters: 3</p>
        ...
        <div>
          ...
          <div className="mt-1">
            <input
              ...
              className={`block w-full rounded-md px-3.5 py-2 shadow-sm sm:text-lg sm:leading-6 outline-none bg-transparent border ${
                companyDetailsError ? "border-red-500" : "border-vavid-gray"
              } text-river-blue`}
            />
            {companyDetailsError && (
              <p className="text-sm text-red-500">Minimum characters: 3</p>
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-1">
            <textarea
              ...
              className={`block w-full rounded-md px-3.5 py-2 shadow-sm sm:text-lg sm:leading-6 outline-none bg-transparent border ${
                messageError ? "border-red-500" : "border-vavid-gray"
